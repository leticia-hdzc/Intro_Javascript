...
console.log("Vamos a contar los números impares de cero al número que ingreses.");
num = parseInt(prompt("¿Qué número quieres ingresar? "))
...
console.log(`La cantidad de números impares desde 0 hasta ${num} (inclusive) son: ${contador_impares}`);